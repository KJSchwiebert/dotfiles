% Overload MATLAB CLEAR function so that we can't delete the whole workspace.
%
% This is all too easy to do if you regularly work in bash or other
% interactive environments where clear means "clear the screen" and not
% "delete all my work".
%
% Now 'clear' is identical to 'clc'. However, any other use of clear should
% be fine. For example 'clear a' or 'clear('a')' clears the variable a.
%
% If you really want to clear the whole workspace use one of these:
%    builtin('clear');
%    clear VARIABLES
%
% Documentation of MATLAB clear.m (even where now incorrect due to the above):
%
